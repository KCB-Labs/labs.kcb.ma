...
|---|---|---|---|---|---|---|---|
| 1 | PBI-001 | Foundation — Astro+React+Keystatic+Node scaffold | kcb/KCBLABS-1 | Active | none | master | — |
| 2 | PBI-002 | Foundation — Design tokens & global styles | kcb/KCBLABS-2 | Proposed | PBI-001 | — | — |
